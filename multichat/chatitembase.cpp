    ...
    , m_role(role)
{
    ...
    QGridLayout *pGLayout = new QGridLayout(); // 网格布局
    ...
    if(m_role == ChatRole::Self)
    {
        ...
        pGLayout->setColumnStretch(0, 2); // 拉伸
        pGLayout->setColumnStretch(1, 3); // 拉伸
    } else {
    ...
    this->setLayout(pGLayout); // 布局添加到widget中
}
...
void ChatItemBase::setWidget(QWidget *w)
{
   ...
   delete m_pBubble; // 防止widget没有指向bubble时，释放后的内存泄漏
   m_pBubble = w;
}
