...
public:
    ...
    void setupUi(QWidget *ApplyFriendPage)
    {
        ...
        ApplyFriendPage->resize(768, 347);
        ...
        friend_apply_label = new QLabel(friend_apply_wid);
        friend_apply_label->setObjectName(QString::fromUtf8("friend_apply_label"));
        friend_apply_label->setMinimumSize(QSize(0, 40));
        friend_apply_label->setMaximumSize(QSize(16777215, 40));

        horizontalLayout->addWidget(friend_apply_label);

        horizontalSpacer = new QSpacerItem(707, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    ...
    void retranslateUi(QWidget *ApplyFriendPage)
    {
        ...
        friend_apply_label->setText(QApplication::translate("ApplyFriendPage", "\346\226\260\347\232\204\346\234\213\345\217\213", nullptr));
    } // retranslateUi
