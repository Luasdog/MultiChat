...
public:
    ...
    void setupUi(QWidget *ConUserItem)
    {
        ...
        icon_label->setGeometry(QRect(0, 10, 45, 45));
        ...
        user_name_label = new QLabel(ConUserItem);
        user_name_label->setObjectName(QString::fromUtf8("user_name_label"));

        horizontalLayout->addWidget(user_name_label);
    ...
    void retranslateUi(QWidget *ConUserItem)
    {
        ...
        user_name_label->setText(QApplication::translate("ConUserItem", "TextLabel", nullptr));
    } // retranslateUi
